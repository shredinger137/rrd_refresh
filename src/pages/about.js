          ...
          <div class="col-sm-auto mx-auto text-center">
            ...
            <div class="row">
              <div class="col-lg-12 text-center">
                <h2 class="section-heading text-white">Community Involvement</h2>
              </div>
              <div class="col-sm-auto mx-auto text-left">
              <hr class="light my-4"></hr>
              <p class="text-main mb-4">
              ...
              <strong>Resurrection Roller Girls' Charity Partners</strong><br></br>

              <ul class="list-unstyled text-main mb-4">
            ...
            <div class="row"><p><br></br><br></br></p></div>
          </div>
          <div class="row">
            ...
            <div class="col-sm-6 text-center">
              <img src="img/cotatitarod.jpg" class="img-fluid" />
            </div>
          </div>
        <div class="row">
